...
app.get("/Item/:Obj/:Type_ID/:School_ID", function (req, resp) {
  connection.query(
    `SELECT * FROM ItemDonate WHERE 
    Quantity!=0 AND Warning!=5 AND Obj LIKE '%${req.params.Obj}%' 
    AND Type_ID = CASE WHEN ${req.params.Type_ID} != 'x' THEN Type_ID = ${req.params.Type_ID} END
    AND School_ID = CASE WHEN ${req.params.School_ID} != 'x' THEN School_ID = ${req.params.School_ID} END
