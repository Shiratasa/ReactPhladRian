...
function R_Main() {
  ...
  const WishCheck = async () => {
    Axios.get(`http://localhost:5000/WishExist/${Student_ID}`).then(
      (response) => {
        setCheck_List(response.data);
      }
    );
  };
