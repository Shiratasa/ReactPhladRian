...
function S_Main() {
  ...
  <div class="tab">
    <button
      id="alttabF"
      class="alttablinks active"
      onclick="openTab(event, 'Tra1')"
    >
      1 - Item is transporting
    </button>
    <button
      class="alttablinks"
      onclick="openTab(event, 'Tra2')"
    >
      2 - Confirm for item arrival
    </button>
    <button
      class="alttablinks"
      onclick="openTab(event, 'Tra3')"
    >
      3 - Successful trade
    </button>
  </div>
  <script>
    function openTab(Aevt, AtabBlock) {
      var j, alttabcontent, alttablinks;
      alttabcontent = document.getElementsByClassName("alttabcontent");
      for (j = 0; j < alttabcontent.length; j++) {
        alttabcontent[j].style.display = "none";
      }
      alttablinks = document.getElementsByClassName("alttablinks");
      for (j = 0; j < alttablinks.length; j++) {
        alttablinks[j].className = alttablinks[j].className.replace(" active", "");
      }
      document.getElementById(AtabBlock).style.display = "block";
      Aevt.currentTarget.className += " active";
    }
    document.getElementById('alttabF').click();
  </script>
  `;
                              ...
                              >
                                <table className="table table-condensed">
                                  ...
                                  <tbody>
                                    ...
                                    <div id="Tra1" class="alttabcontent">
                                      <tbody>
                                        {Re1Slice.map((val, key) => {
                                          return (
                                            <tr>
                                    ...
                                    <div id="Tra2" class="alttabcontent">
                                      <tbody>
                                        {Re2Slice.map((val, key) => {
                                          return (
                                            <tr>
                                    ...
                                    <div id="Tra3" class="alttabcontent">
                                      <tbody>
                                        {Re3Slice.map((val, key) => {
                                          return (
                                            <tr>
