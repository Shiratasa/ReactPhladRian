                                ...
                                <div className="features_items">
                                  ...
                                  <div className="col-sm-12 picList">
                                    {Item_List.filter((val) => {
                                      if (SearchString == "" && CategString == "" && SchoolString == "") 
                                      {
                                        return val;
                                      } 
                                      else if (val.Obj.toLowerCase().includes(SearchString.toLowerCase()) &&
                                        CategString == "" && SchoolString == "") 
                                        {
                                        return val;
                                      } 
                                      else if (
                                        val.Obj.toLowerCase().includes(SearchString.toLowerCase()) &&
                                        val.Type_ID == CategString && SchoolString == "") 
                                        {
                                        return val;
                                      } 
                                      else if (
                                        val.Obj.toLowerCase().includes(SearchString.toLowerCase()) &&
                                        val.Type_ID == CategString && val.School_ID == SchoolString) 
                                        {
                                        return val;
                                      } 
                                    }).map((val, key) => {
