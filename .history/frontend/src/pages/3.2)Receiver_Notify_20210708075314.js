...
function R_Main() {
  ...
  const ItemBlock2 = async () => {
    Axios.post(`http://localhost:5000/Notify2`, {
      School_ID: TypeValue,
      Type_ID: SchoolValue,
    }).then((response) => {
                              ...
                              <div className="col-sm-12">
                                <div className="features_items">
                                  <div className="brands_products">
                                    <h2 className="title text-center" onClick={ItemBlock3}>
                                      Notification Items
                                    </h2>
                                    <button type="button" onCLick={ItemBlock}>x</button>
                                    <button type="button" onCLick={ItemBlock2}>y</button>
                                    <button type="button" onCLick={ItemBlock3}>z</button>
                                  </div>
                                  <div className="col-sm-12 picList">
                                    {Wish_List.map((val, key) => {
                                      return (
