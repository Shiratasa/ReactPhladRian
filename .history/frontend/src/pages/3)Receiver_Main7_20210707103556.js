...
function R_Main() {
  ...
  function filterRedirection() {
    ...
    if (
      ...
      history.push(`/r_main/${Student_ID}/${textQuery.value}`);
      window.location.reload();
    }
    if (
      textQuery.value == "" &&
      ...
      history.push(`/r_main/${Student_ID}/${schoolQuery.value}`);
      window.location.reload();
    }
    if (
      textQuery.value != "" &&
      ...
      history.push(
        `/r_main/${Student_ID}/${schoolQuery.value}/${textQuery.value}`
      );
      window.location.reload();
    }
    if (
      ...
      history.push(`/r_main/${Student_ID}/${categQuery.value}`);
      window.location.reload();
    }
    if (
      textQuery.value != "" &&
      ...
      history.push(
        `/r_main/${Student_ID}/${categQuery.value}/${textQuery.value}`
      );
      window.location.reload();
    }
    if (
      ...
      history.push(
        `/r_main/${Student_ID}/${categQuery.value}/${schoolQuery.value}`
      );
      window.location.reload();
    }
    if (
      ...
      history.push(
        `/r_main/${Student_ID}/${categQuery.value}/${schoolQuery.value}/${textQuery.value}`
      );
      window.location.reload();
    }
  }
