...
function R_Main() {
  ...
  const ItemBlock = async () => {
    Axios.get(`http://localhost:5000/Item/${Type_ID}/${School_ID}/${Obj}`).then((response) => {
  ...
  function filterRedirection() {
    ...
    if (
      ...
      history.push(`/r_main/${Student_ID}/obj/${textQuery.value}`);
      window.location.reload();
    }
    if (
      textQuery.value == "" &&
      ...
      history.push(`/r_main/${Student_ID}/sch/${schoolQuery.value}`);
      window.location.reload();
    }
    if (
      textQuery.value != "" &&
      ...
      history.push(
        `/r_main/${Student_ID}/sch/${schoolQuery.value}/obj/${textQuery.value}`
      );
      window.location.reload();
    }
    if (
      ...
      history.push(`/r_main/${Student_ID}/typ/${categQuery.value}`);
      window.location.reload();
    }
    if (
      textQuery.value != "" &&
      ...
      history.push(
        `/r_main/${Student_ID}/typ/${categQuery.value}/obj/${textQuery.value}`
      );
      window.location.reload();
    }
    if (
      ...
      history.push(
        `/r_main/${Student_ID}/typ/${categQuery.value}/sch/${schoolQuery.value}`
      );
      window.location.reload();
    }
    if (
      ...
      history.push(
        `/r_main/${Student_ID}/typ/${categQuery.value}/sch/${schoolQuery.value}/obj/${textQuery.value}`
      );
      window.location.reload();
    }
  }
