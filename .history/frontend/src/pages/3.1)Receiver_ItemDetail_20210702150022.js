...
function R_Item() {
  ...
  var cNum = document.getElementById("totalChance").innerHTML;
  ...
  const R_deli = async () => {
    if(cNum == "0/5") {
      JSAlert.alert("", "You are running out of request chance...", JSAlert.Icons.Failed);
      throw "exit";
    }
    alert(cNum);
                          ...
                          <div className="content first-content">
                            <div className="container">
                              ...
                              <div className="col-sm-9">
                                ...
                                <hr className="soft" />
                                <button type="button" className="btn swappor" onClick={R_deli}>
