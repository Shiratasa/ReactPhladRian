...
function R_Main() {
  ...
  const ItemBlock = async () => {
    Axios.get(`http://localhost:5000/Item/${Obj}/${Type_ID}/${School_ID}`).then((response) => {
                                  ...
                                  <div className="brands-name">
                                    <form className="searchform">
                                      ...
                                      <button
                                        ...
                                        onClick={() => {
                                          history.push(
                                            `/r_main/${Student_ID}/${textQuery.value}/${Search_CategRef.current}/${Search_SchoolRef.current}`
                                          );
                                          window.location.reload();
                                        }}
