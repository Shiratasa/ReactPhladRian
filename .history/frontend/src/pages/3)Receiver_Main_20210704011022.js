                                    ...
                                    <ul className="nav nav-pills nav-stacked">
                                      <select
                                        ...
                                        onChange={(event) => {
                                          ...
                                          alert(Search_SchoolRef.current);
                                        }}
                                      >
                                ...
                                <div className="features_items">
                                  ...
                                  <div className="col-sm-12 picList">
                                    {ItemSlice.filter((val) => {
                                      if ((Search_CategRef.current == "0") || (Search_CategRef.current == "")) {
                                        return val;
                                      }
                                      else if (
                                        val.Type_ID.toLowerCase().includes(
                                          Search_CategRef.current.toLowerCase()
                                        )
                                      ) {
                                        return val;
                                      }
