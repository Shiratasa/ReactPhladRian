                          ...
                          <div className="container">
                            ...
                            <div className="col-sm-9">
                              ...
                              <p align="justify">
                                ...
                                summarizes 5 main subjects into one book. And it
                                also has the exercises at the end of each
                                chapter and the pass O-net exam of the previous
                                years for you to try. If you still don't
                                understand why each of these questions answered,
                                it has complete detailed solutions for children
                                to understand as well. In addition to the many
                                exams for children to do, it also has content to
                                study as well.
                              </p>
                              <hr className="soft" />
