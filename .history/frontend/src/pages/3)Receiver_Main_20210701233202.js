...
function R_Main() {
  ...
  const [Re5_List, setRe5_List] = useState([]);
  const Re5Slice = Re5_List.slice(FirstQuery7, LastQuery7);
  const Re5Count = Math.ceil(Re5_List.length / Page_AllPost7);
                                ...
                                <table className="table table-condensed">
                                  ...
                                  <tbody>
                                    ...
                                    <div id="Deli1" class="tabcontent">
                                      <h3>Process1</h3>
                                      <p>Wait for Donor response</p>
                                    </div>
                                    <div id="Deli2" class="tabcontent">
                                      <h3>Process2</h3>
                                      <p>Donor delivers the item</p>
                                    </div>
                                    <div id="Deli3" class="tabcontent">
                                      <h3>Process3</h3>
                                      <p>Item is transporting</p>
                                    </div>
                                    <div id="Deli4" class="tabcontent">
                                      <h3>Process4</h3>
                                      <p>Confirm for item arrival</p>
                                    </div>
