...
function D_Main() {
  ...
  const Re1Block = async () => {
    Axios.get(`http://localhost:5000/Re1/${Donor_ID}`).then((response) => {
      setRe1_List(response.data);
    });
  };
  const Re2Block = async () => {
    Axios.get(`http://localhost:5000/Re2/${Donor_ID}`).then((response) => {
      setRe2_List(response.data);
    });
  };
  const Re3Block = async () => {
    Axios.get(`http://localhost:5000/Re3/${Donor_ID}`).then((response) => {
      setRe3_List(response.data);
    });
  };
  const Re4Block = async () => {
    Axios.get(`http://localhost:5000/Re4/${Donor_ID}`).then((response) => {
