...
class App extends React.Component {
  handleClick1 = () => {
    this.props.history.push("/r_main");
  };
  handleClick2 = () => {
    this.props.history.push("/d_main");
  };
  handleClick3 = () => {
    this.props.history.push("/s_main");
  };
  render() {
    return (
      <div className="App">
                ...
                <div className="col-md-offset-2 col-md-8 col-sm-12">
                  <div className="home-thumb">
                    ...
                    <h3 className="wow fadeInUp" data-wow-delay="1.0s">
                      <strong>Let's share our learning tools together!</strong>
                    </h3>
                  </div>
                </div>
              </div>
            ...
            <div className="modal-dialog">
              <div className="modal-content modal-popup">
                ...
                <form action="#" method="post">
                  ...
                  />{" "}
                  {/*type="button" onclick={"props.history.push({R_Main})"}*/}
                </form>
