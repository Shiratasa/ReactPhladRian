                          ...
                          <div className="col-sm-9">
                            <table className="table-condensed" style={{float: 'right'}}>
                              <tbody><tr><td className="cart_delete">
                                    <a className="cart_quantity_delete" href="/r_main"><i className="fa fa-times" /></a>
                                  </td>
                                </tr></tbody></table>
